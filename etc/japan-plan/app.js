...
{key:'d2-depart',date:'2026-08-29',time:'06:30',title:'🌅 삿포로 출발',desc:'후라노·비에이로 이동',dest:'Farm Tomita, Hokkaido',lat:43.4173,lon:142.4253,nav:true},
...
{key:'d2-lunch',date:'2026-08-29',time:'12:00',title:'🍛 비에이 점심',desc:'점심 후 구릉 드라이브',dest:'Biei, Hokkaido',lat:43.5883,lon:142.4669,nav:true},
...
{key:'d2-checkin',date:'2026-08-29',time:'17:30',title:'🏨 후라노 숙소 체크인',desc:'잠깐 쉬고 저녁 산책 준비',dest:'Furano, Hokkaido',lat:43.3420,lon:142.3830,nav:true},
...
{key:'d3-depart',date:'2026-08-30',time:'06:30',title:'☕ 후라노 출발',desc:'샤코탄으로 장거리 이동',dest:'Cape Kamui, Hokkaido',lat:43.3340,lon:140.3470,nav:true},
{key:'d3-kamui',date:'2026-08-30',time:'11:00',title:'🌊 신카무이곶',desc:'강풍 통제 여부 먼저 확인',dest:'Cape Kamui, Shakotan, Hokkaido',lat:43.3340,lon:140.3470,nav:true},
{key:'d3-uni',date:'2026-08-30',time:'12:45',title:'🟠 샤코탄 생우니 점심',desc:'성게 시즌 막바지',dest:'Shakotan Uni Don, Hokkaido',lat:43.2985,lon:140.5988,nav:true},
{key:'d3-shimamui',date:'2026-08-30',time:'14:15',title:'🪨 시마무이 해안',desc:'전망대 중심으로 짧게',dest:'Shimamui Coast, Shakotan, Hokkaido',lat:43.2760,lon:140.4640,nav:true},
{key:'d3-sakaimachi',date:'2026-08-30',time:'16:10',title:'🛍️ 오타루 사카이마치',desc:'상점 닫기 전 먼저 둘러보기',dest:'Sakaimachi Street, Otaru, Hokkaido',lat:43.1906,lon:141.0075,nav:true},
{key:'d3-canal',date:'2026-08-30',time:'17:20',title:'🌆 오타루 운하',desc:'해질 무렵부터 야경까지',dest:'Otaru Canal, Hokkaido',lat:43.1987,lon:140.9947,nav:true},
{key:'d3-dinner',date:'2026-08-30',time:'18:30',title:'🍣 오타루 스시 · 숙박',desc:'저녁 후 운하 도보권에서 숙박',dest:'Sushi Otaru Hokkaido',lat:43.1907,lon:140.9947,nav:true},
{key:'d4-depart',date:'2026-08-31',time:'08:30',title:'🚙 오타루 출발',desc:'국도 393호 → 요테이산',dest:'Fukidashi Park, Hokkaido',lat:42.8582,lon:140.8707,nav:true},
...
'd2-depart':{stay:'-',next:'🚗 약 2시간 20분',nextName:'Farm Tomita'},
'd2-tomita':{stay:'약 1시간',next:'🚗 약 35분',nextName:'사계채의 언덕'},
'd2-shikisai':{stay:'약 1시간 10분',next:'🚗 약 20분',nextName:'비에이 점심'},
'd2-lunch':{stay:'약 50분',next:'🚗 약 10분',nextName:'패치워크 로드'},
'd2-patchwork':{stay:'약 1시간 20분',next:'🚗 약 35분',nextName:'청의 호수'},
'd2-bluepond':{stay:'약 40분',next:'🚗 약 10분',nextName:'흰수염 폭포'},
'd2-falls':{stay:'약 25분',next:'🚗 약 50분',nextName:'후라노 숙소'},
'd2-checkin':{stay:'약 30분',next:'🚗 약 15분',nextName:'닝구르테라스'},
'd2-ningle':{stay:'약 1시간',next:'-',nextName:'숙소'},
'd3-depart':{stay:'-',next:'🚗 약 4시간',nextName:'신카무이곶'},
'd3-kamui':{stay:'약 1시간 10분',next:'🚗 약 30분',nextName:'우니 점심'},
'd3-uni':{stay:'약 1시간',next:'🚗 약 20분',nextName:'시마무이 해안'},
'd3-shimamui':{stay:'약 30분',next:'🚗 약 1시간 30분',nextName:'오타루 사카이마치'},
'd3-sakaimachi':{stay:'약 1시간',next:'🚶 약 10분',nextName:'오타루 운하'},
'd3-canal':{stay:'약 50분',next:'🚶 약 10분',nextName:'오타루 스시'},
'd3-dinner':{stay:'약 1시간 30분',next:'-',nextName:'숙소'},
'd4-depart':{stay:'-',next:'🚗 약 1시간 30분',nextName:'후키다시 공원'},
...
'd5-breakfast':{stay:'약 1시간',next:'🚗 약 10분',nextName:'지옥계곡·오유누마'},
...
{dayId:'day3',label:'오타루',place:'Otaru, Hokkaido, Japan',checkin:'2026-08-30',checkout:'2026-08-31'},
{dayId:'day4',label:'노보리베츠',place:'Noboribetsu Onsen, Hokkaido, Japan',checkin:'2026-08-31',checkout:'2026-09-01'}
];

const routePoints=[
['신치토세공항',42.7752,141.6923],['삿포로',43.0618,141.3545],['BIC Apple Shop',43.0680,141.3510],['Farm Tomita',43.4173,142.4253],['Shikisai-no-Oka',43.5290,142.4650],['청의 호수',43.4935,142.6140],['Ningle Terrace',43.3235,142.3573],['신카무이곶',43.3340,140.3470],['시마무이 해안',43.2760,140.4640],['오타루',43.1987,140.9947],['후키다시 공원',42.8582,140.8707],['니세코',42.8048,140.6874],['도야호',42.6036,140.8650],['노보리베츠',42.4923,141.1445],['신치토세공항',42.7752,141.6923]
];
...
function getCurrentStop(){const now=new Date(),today=todayISO();if(today<'2026-08-28')return schedule[0];if(today>'2026-09-01')return null;const list=schedule.filter(s=>s.date===today&&!isDone(s));if(!list.length)return null;return list.find(s=>dt(s)>=new Date(now.getTime()-45*60000))||list[list.length-1]}
...
function navigateNext(){currentStop=getCurrentStop();if(!currentStop){toast('남은 일정이 없습니다');return}if(!currentStop.nav){jumpToCurrentStop();return}const fallback=()=>window.open(`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(currentStop.dest)}&travelmode=driving`,'_blank');if(!navigator.geolocation){fallback();return}$('gpsNote').textContent='현재 위치 확인 중…';navigator.geolocation.getCurrentPosition(p=>{const a=p.coords.latitude,b=p.coords.longitude,km=(currentStop.lat&&currentStop.lon)?haversine(a,b,currentStop.lat,currentStop.lon):null;$('gpsNote').textContent=km?`다음 목적지까지 직선거리 약 ${km.toFixed(km<10?1:0)} km`:'현재 위치 반영됨';window.open(`https://www.google.com/maps/dir/?api=1&origin=${a},${b}&destination=${encodeURIComponent(currentStop.dest)}&travelmode=driving`,'_blank')},()=>{toast('위치 권한 없이 목적지만 엽니다');fallback()},{enableHighAccuracy:true,timeout:7000,maximumAge:60000})}
...
document.addEventListener('DOMContentLoaded',()=>{refreshWeather();restoreDone();markToday();initTimingMeta();initSearchButtons();initMap();initNotes();updateNowCard();updateProgress();onlineState();setInterval(updateNowCard,60000);if('serviceWorker'in navigator)navigator.serviceWorker.register('./sw.js').catch(()=>{})});