...
document.addEventListener('DOMContentLoaded',()=>{refreshWeather();restoreDone();markToday();initTimingMeta();initSearchButtons();initNotes();applyConfirmedHotels();initMap();updateNowCard();updateProgress();onlineState();setInterval(updateNowCard,60000);if('serviceWorker'in navigator)navigator.serviceWorker.register('./sw.js').catch(()=>{})});