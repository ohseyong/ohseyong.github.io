...
- **로제타2는 정말 신기합니다.**
  인텔맥용 소프트웨어와 ARM맥용 소프트웨어가 아주 아주 Seamless 하게 구동됩니다. 솔직히 직접 앱을 우클릭해서 하나하나 확인해보지 않으면 어느게 인텔맥용인지도 모를 정도로 빠르게 잘 돌아가요. (실제로 인텔맥북 16인치에서 포토샵을 켜는 것보다, ARM맥에서 인텔맥용 포토샵을 로제타 통해 구동하는게 초기 구동부터 더 빨라요...) 애플이 도대체 뭘 만든거죠. 덕분에 LLVM과 컴파일러에 대해 공부하는 시간까지 가졌습니다.
