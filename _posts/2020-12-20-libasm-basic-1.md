---
title: "[42 Seoul] libasm 과제를 위해 알아야 할 어셈블리어 살펴보기"
...
* [RSP와 RBP를 활용하기 위해 알아야 하는 스택포인터에 대한 정보](https://blog.kimtae.xyz/9)[^출처]
...
[^ 출처 ]:yechoi님 블로그 글을 읽다가 발견했는데 도움이 많이 된 글이었다
