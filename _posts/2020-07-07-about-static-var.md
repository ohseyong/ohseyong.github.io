...
hycho님 덕분에 GNL 과제에 있어 꼭 필요한 static 변수 개념에 대해 다시 한 번 공부할 수 있었다. 좋은 시간을 보낼 수 있어 감사한 마음이다. 개포동 어디에선가는 극히 드물게 정적 변수가 무엇인지 전혀 모르는 상태에서 GNL을 통과하는 기적이 일어나기도 한다고 들었지만, 여러모로 정적 변수 개념은 더할 나위 없이 중요한 개념이므로 꼭 기억해둬야겠다.